...
const proxy = {
  ...
  // 'GET /teil/(.*)': 'http://localhost:18080/teil',
  // 'POST /teil/(.*)': 'http://localhost:18080/teil',
  // 'DELETE /teil/(.*)': 'http://localhost:18080/teil',
  // 'PUT /teil/(.*)': 'http://localhost:18080/teil',
};

export default (noProxy ? {} : delay(proxy, 0));
// export default {
//   'GET /datapack/(.*)': 'https://localhost:18080/datapack',
// };
